...
make COPTS="-DHAVE_IPSET -DHAVE_BROKEN_RTC -DHAVE_AUTH -DNO_TFTP -DNO_ID -DHAVE_LOOP -DNO_INOTIFY -DNO_DUMPFILE -DNO_GMP -DHAVE_DNSSEC -DVERSION=\\\"$ver\\\"" CFLAGS="-I/usr/local/include"
